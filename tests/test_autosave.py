...
def test_submit_merges_autosave_snapshot_before_scoring(client):
    ...
    with patch("app.routers.exam.load_autosave_snapshot",
        ...
        atable_mock.return_value.update.return_value.eq.return_value.not_.in_.return_value.execute = AsyncMock(return_value=MagicMock(data=[{"session_key": "ALICE001_123"}]))
