...
// The F4 hardware key's coverage is separately unclear — Launchpad
// activation via F4 may be a `com.apple.symbolichotkeys`-level binding
// (same "system takes precedence" class as Cmd+Tab/Spotlight/Screenshots)
// independent of the gesture setting above, not researched further here.
