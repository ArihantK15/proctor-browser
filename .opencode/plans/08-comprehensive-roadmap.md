...
| # | Item | Effort | Why |
|---|------|--------|-----|
| 7 | **Full CI security scanning** — Gitleaks (secrets), Semgrep (SAST), Trivy (container), pip-audit (deps), npm audit (js deps) | 1 day | Enterprise security baseline |
...
| 9 | **Dashboard build/audit in CI** + scripts/quality_check.sh documented as required release steps | 4 hr | Prevents build drift |
