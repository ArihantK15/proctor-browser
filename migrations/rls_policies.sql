...
DROP POLICY IF EXISTS exam_sessions_student_update ON exam_sessions;
...
DROP POLICY IF EXISTS violations_teacher_select ON violations;
CREATE POLICY violations_teacher_select ON violations FOR SELECT USING (teacher_id::text = public.get_my_teacher_id());
DROP POLICY IF EXISTS violations_student_insert ON violations;
...
DROP POLICY IF EXISTS violations_teacher_delete ON violations;
...
DROP POLICY IF EXISTS answers_student_insert ON answers;
...
DROP POLICY IF EXISTS answers_student_select ON answers;
...
DROP POLICY IF EXISTS demo_requests_teacher_select ON demo_requests;
