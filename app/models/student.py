...
class RegisterIn(BaseModel):
    ...
    exam_id:     str | None = Field(default=None, max_length=64)
    ...
    date_of_birth: str | None = Field(default=None, max_length=10)  # YYYY-MM-DD
    guardian_email: str | None = Field(default=None, max_length=254)
