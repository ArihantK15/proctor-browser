            ...
            {steps.map((item, i) => (
              ...
              >
                <div className="relative mx-auto mb-6 flex h-24 w-24 items-center justify-center">
                  <div className="absolute inset-0 rounded-2xl border border-white/[0.06] bg-navy-800 grain-overlay" />
                  <item.icon size={28} className="relative z-10 text-accent-light" />
                  <span className="absolute -top-2 -right-2 z-10 flex h-6 w-6 items-center justify-center rounded-full bg-accent-dark font-mono text-[10px] font-bold text-white accent-glow">
                    {item.step}
                  </span>
                </div>
